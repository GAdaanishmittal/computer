...
Write-Host "`nStopping API and Frontend..." -ForegroundColor Yellow
$ports = @(8008, 3000)
...
# Stop Sandbox
Write-Host "`nStopping Kortix Sandbox..." -ForegroundColor Yellow
docker stop kortix-sandbox 2>$null | Out-Null

# Stop Supabase
Write-Host "`nStopping Supabase stack..." -ForegroundColor Yellow
...
Write-Host "`nKortix Platform stopped!" -ForegroundColor Green
